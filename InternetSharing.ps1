...
Set-MrInternetConnectionSharing -InternetInterfaceName "Ethernet 2" -LocalInterfaceName "OpenVPN TAP-Windows6" -Enabled $false
Get-MrInternetConnectionSharing -InternetInterfaceName "Ethernet 2", "OpenVPN TAP-Windows6"
Set-MrInternetConnectionSharing -InternetInterfaceName "Ethernet 2" -LocalInterfaceName "OpenVPN TAP-Windows6" -Enabled $true
Get-MrInternetConnectionSharing -InternetInterfaceName "Ethernet 2", "OpenVPN TAP-Windows6"
